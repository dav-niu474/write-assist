...
### v1.3.0 (2026-03-28) - MediaCrawler集成

**新增功能**
- ✅ MediaCrawler集成: 抓取小红书、抖音、B站、微博内容
- ✅ 内容搜索: 按关键词搜索已抓取的笔记/视频
- ✅ 一键收藏: 抓取内容快速保存到素材库
- ✅ 服务状态检测: 自动检测MediaCrawler服务状态
- ✅ 多平台支持: 小红书、抖音、B站、微博四大平台

**使用方法**
1. 启动 MediaCrawler 服务: `cd MediaCrawler && python -m api.main`
2. 点击侧边栏"内容抓取"入口
3. 选择平台、输入关键词搜索或抓取

### v1.2.0 (2026-03-28) - Chrome浏览器插件

**新增功能**
- ✅ Chrome浏览器插件: 一键收藏网页内容
- ✅ 右键菜单收藏: 支持收藏页面、选中文本、图片、链接
- ✅ 浮动快捷按钮: 页面右下角快速收藏入口
- ✅ 选中文本快捷收藏: 选中文字后自动显示收藏按钮
- ✅ 独立设置页面: 配置API地址、测试连接

**插件目录**
- `chrome-extension/` - Chrome插件完整代码
